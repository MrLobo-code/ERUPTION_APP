...
const Pro2SmartTV = () => {
    ...
    const [currentImage, SetCurrentImage] = useState("/src/assets/testImages/pr2/1.jpg");
    ...
    const handleCurrentImage = (val) => {
        switch (val) {
            case 1:
                updateImage("/src/assets/testImages/pr2/1.jpg", val);
                break;
            case 2:
                updateImage("/src/assets/testImages/pr2/2.jpg", val);
                break;
            case 3:
                updateImage("/src/assets/testImages/pr2/3.jpg", val);
                break;
            case 4:
                updateImage("/src/assets/testImages/pr2/4.jpg", val);
                break;
            case 5:
                updateImage("/src/assets/testImages/pr2/5.jpg", val);
                break;
            default:
                console.log(`Error`);
        }
                ...
                <div className="m-4 mb-4 flex justify-center">
                    {
                        ...
                        status != "authenticated"
                            ? (
                                <>
                                    <div className="blur-sm">
                                        <figure className="max-w-lg">
                                            <img className="h-auto max-w-full rounded-lg" src="/src/assets/productsImgs/SmartTV.jpg" alt="image description" />
                                            <figcaption className="mt-2 text-sm text-center text-gray-500 dark:text-gray-400">Image caption</figcaption>
                                        </figure>
                                    </div>
                                </>
                            ...
                            : (
                                <>
                                    <stripe-buy-button
                                        buy-button-id="buy_btn_1POixtP3BkSI1DXnt4BWM8gH"
