...
const CartProduct = ({ id, img, username, title, description, price }) => {
    ...
    useEffect(() => {
        handleValidateProductExistence();
    }, []);

    const handleValidateProductExistence = async () => {
        try {
            const response = await apiAuth({
                method: 'post',  //must to be POST method
                url: '/prudct_exist',
                data: {
                    ProductName: title
                },
    ...
    const handleItemDelete = async () => {
        try {
            ...
            AutocloseAlert("Registro eliminado");
            navigate(0);
        } catch (e) {
            console.log(e);
        }
                    ...
                    ? (<div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                        <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                            <a href="#" className="shrink-0 md:order-1">
                                ...
                                <a href="#" className="text-base font-medium text-red-700-900 dark:text-red-700">SIN STOCK</a>
                            ...
                            <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                <a href="#" className="text-base font-medium text-gray-900 hover:underline dark:text-white">{title}: {description}</a>
                            ...
                            Add to Favorites
                                    ...
                                    <button type="button" onClick={handleItemDelete} className="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500">
