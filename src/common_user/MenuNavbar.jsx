        ...
        <>
            {
                ...
                status != "no-autenticated" //RECTIFICAR SI ESTA LINEA FUNCIONA BIEN
                    ? (
                        <>
